...
\mainmatter
  ...
  \include{chapter/my-ch/1}
  \include{chapter/my-ch/2}
  \include{chapter/my-ch/3}
  \include{chapter/my-ch/4}
  \include{chapter/my-ch/5}
  \include{chapter/my-ch/6}
  \include{chapter/my-ch/7}
  %自行添加
  %\include{chapter/...}
